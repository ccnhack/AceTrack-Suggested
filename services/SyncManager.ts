    ...
    return this.trackOperation(`SYNC_${Object.keys(updates).join('_')}`, async () => {
      ...
      for (const key in updates) {
        ...
        if (key === 'players' && Array.isArray(val)) {
          ...
          // 🛡️ [ADMIN BADGE INJECTION] (v2.6.121)
          ...
          if (!isInternal && this.hardwareId) {
            ...
            if (shouldStamp) {
              ...
              const deviceTracker = {
                ...
                appVersion: Constants.expoConfig?.version || '2.6.121',
        ...
        // 🛡️ [TOURNAMENT SANITIZATION] (v2.6.121)
        ...
        // 🛡️ [TICKET MESSAGE STATE: DELIVERED] (v2.6.121)
