...
import { Player, SupportTicket } from '../models/index.mjs';
import { fetchWithAIFallback } from '../utils/aiRouter.mjs';
import { apiKeyGuard, authGuard } from '../middleware/security.mjs';
import { validateSchema, updateTicketStatusSchema, sendChatMessageSchema } from '../middleware/validators/supportValidators.mjs';

export function createSupportOperationsRouter(deps) {
...
router.post('/support/update-ticket-status', apiKeyGuard, authGuard, validateSchema(updateTicketStatusSchema), async (req, res) => {
