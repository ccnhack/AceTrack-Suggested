...
const APP_VERSION = '2.6.392'; // Critical for Update prompts 
...
// 🛡️ DIAGNOSTICS: Global Request Logger (v2.6.392)
...
app.use('/api/comms', commsRoutes); // 🛡️ Legacy/Compatibility Alias (v2.6.392)
