...
const APP_VERSION = '2.6.390'; // Critical for Update prompts 
...
// 🛡️ DIAGNOSTICS: Global Request Logger (v2.6.390)
...
app.use('/api/comms', commsRoutes); // 🛡️ Legacy/Compatibility Alias (v2.6.390)
