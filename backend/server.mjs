...
const APP_VERSION = '2.6.389'; // Critical for Update prompts 
...
// 🛡️ DIAGNOSTICS: Global Request Logger (v2.6.389)
...
app.use('/api/comms', commsRoutes); // 🛡️ Legacy/Compatibility Alias (v2.6.389)
