...
export const OTHER_PLAYERS: Player[] = [
    { id: 'rohan', name: 'Rohan Sharma', phone: '9988776655', avatar: '', skillLevel: SkillLevel.INTERMEDIATE, rating: 1210, matchesPlayed: 5, wins: 3, losses: 2, noShows: 1, cancellations: 0, preferredFormat: 'Doubles', mostPlayedVenue: 'Sarjapur Indoor Arena', city: 'Bangalore', email: 'rohan@test.com', credits: 0, cancelledTournamentIds: [], trueSkillRating: 1210, trueSkillHistory: [{ date: '2025-01-01', rating: 1180 }, { date: '2025-02-01', rating: 1210 }], role: 'user', sport: Sport.BADMINTON },
    { id: 'sneha', name: 'Sneha Rao', phone: '9123456789', avatar: '', skillLevel: SkillLevel.INTERMEDIATE, rating: 1280, matchesPlayed: 20, wins: 15, losses: 5, noShows: 0, cancellations: 2, preferredFormat: 'Both', mostPlayedVenue: 'PCA Stadium Grounds', city: 'Bangalore', email: 'sneha@test.com', credits: 0, cancelledTournamentIds: [], trueSkillRating: 1280, trueSkillHistory: [{ date: '2025-01-01', rating: 1200 }, { date: '2025-02-01', rating: 1280 }], role: 'user', sport: Sport.BADMINTON },
    { id: 'kiran', name: 'Kiran K', phone: '9334455667', avatar: '', skillLevel: SkillLevel.INTERMEDIATE, rating: 1190, matchesPlayed: 8, wins: 4, losses: 4, noShows: 0, cancellations: 0, preferredFormat: 'Singles', mostPlayedVenue: 'E-City Arena', city: 'Bangalore', email: 'kiran@test.com', credits: 0, cancelledTournamentIds: [], trueSkillRating: 1190, trueSkillHistory: [{ date: '2025-01-01', rating: 1150 }, { date: '2025-02-01', rating: 1190 }], role: 'user' },
    { id: 'shashank', name: 'Shashank', phone: '9000000001', avatar: '', skillLevel: SkillLevel.BEGINNER, rating: 1000, matchesPlayed: 0, wins: 0, losses: 0, noShows: 0, cancellations: 0, preferredFormat: 'Singles', city: 'Bangalore', email: 'shashank@test.com', credits: 100, cancelledTournamentIds: [], trueSkillRating: 1000, isEmailVerified: true, isPhoneVerified: true, role: 'user', sport: Sport.TABLE_TENNIS },
    { id: 'pranshu', name: 'Pranshu', phone: '9000000002', avatar: '', skillLevel: SkillLevel.BEGINNER, rating: 1050, matchesPlayed: 0, wins: 0, losses: 0, noShows: 0, cancellations: 0, preferredFormat: 'Singles', city: 'Bangalore', email: 'pranshu@test.com', credits: 100, cancelledTournamentIds: [], trueSkillRating: 1050, role: 'user' },
    { id: 'rahul', name: 'Rahul', phone: '9000000005', avatar: '', skillLevel: SkillLevel.BEGINNER, rating: 1020, matchesPlayed: 0, wins: 0, losses: 0, noShows: 0, cancellations: 0, preferredFormat: 'Singles', city: 'Bangalore', email: 'rahul@test.com', credits: 100, cancelledTournamentIds: [], trueSkillRating: 1020, role: 'user' },
    { id: 'coach_1', name: 'Coach Pullela', phone: '9000000003', avatar: '', skillLevel: SkillLevel.ADVANCED, rating: 2500, matchesPlayed: 0, wins: 0, losses: 0, noShows: 0, cancellations: 0, preferredFormat: 'Singles', city: 'Bangalore', email: 'coach@test.com', credits: 0, cancelledTournamentIds: [], role: 'coach', isApprovedCoach: true, certifiedSports: [Sport.BADMINTON], password: 'password', trueSkillRating: 2500 },
    { id: 'coach_2', name: 'Pending Coach', phone: '9000000004', avatar: '', skillLevel: SkillLevel.ADVANCED, rating: 2500, matchesPlayed: 0, wins: 0, losses: 0, noShows: 0, cancellations: 0, preferredFormat: 'Singles', city: 'Bangalore', email: 'pending@test.com', credits: 0, cancelledTournamentIds: [], role: 'coach', isApprovedCoach: false, certifiedSports: [Sport.TABLE_TENNIS], password: 'password', trueSkillRating: 2500 },
];
