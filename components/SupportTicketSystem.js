...
export const SupportTicketSystem = ({
  ...
  if (view === 'create') {
    return <TicketCreateView {...{ setView, showTypePicker, setShowTypePicker, formData, setFormData, handleCreate, showAgentPicker, setShowAgentPicker, filterAgentId, setFilterAgentId, availableAgents, TICKET_TYPES }} />;
  }
